...
See [ADR-002](./ADR-002-bounded-contexts.md) for bounded context definitions, [ADR-004](./ADR-004-data-technology.md) for the data technology decision, and [ADR-006](./ADR-006-frontend-architecture.md) for frontend package structure.
